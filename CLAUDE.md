...
- Colores (`DEF_COLS_RFR`, definidos por el usuario): sobremadura morado `#7E57C2`, deforme rosa apagado `#C97B93`, irregular amarillo pollo `#E8D06A`, desgrane naranja `#E67E22`, hongos gris `#888780`; y `RFR_COL_BUENOS` es `#ea3155`, con etiqueta `RFR_LBL_BUENOS` = "kg bueno". Esa constante alimenta tanto la dona como los puntitos de las filas de defectos, así que cambiarla actualiza los dos a la vez.
